...
class TaskExecutor extends Command
{
    ...
    {
        $this->addOption('pid_file', 'pfi', InputOption::VALUE_REQUIRED, 'Swoole server pid file.', env('SCHEDULE_PARSER_PID_FILE', '/tmp/schedule_parser_001.pid'))
        ->addOption('job_group', 'jg', InputOption::VALUE_OPTIONAL, 'Job Execute Group', '');
    }
    ...
    protected function start()
    {
        ...
        $this->info('> (You can run this command to ensure the ' .
            'swoole_process_pool process is running: ps aux|grep "swoole")');
